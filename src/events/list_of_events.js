// Example of an event with photo  ["March 3, 2023", "Figirst day of the season we are back to being open!", pavilion_photo]
// Example of an event without photo  ["March 3, 2023", "First day of the season we are back to being open!"]
// For now this array needs to be in date order.

  const events = [
        ["April 1, 2023", "This is a test case, it should not appear!"],
